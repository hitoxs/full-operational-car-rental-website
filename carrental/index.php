...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Rent a car today <span>and explore the world.</span></h2>
      <p>Discover the freedom of the road with our affordable car rental services. We have a wide range of vehicles to choose from, including economical, luxury, and family options. Whether you're planning a road trip, need a reliable car for a business trip, or simply want to explore your local area, we have what you need.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Our Cars</a></li>
        </ul>
      </div>
...
<span class="price">Day/ <?php echo htmlentities($result->PricePerDay);?> Dh</span> 
</div>
